...
public class TopMenu {
	...
	public JMenuBar menu(MathViewer viewer) {
		...
		checkboxItemA.setMnemonic(KeyEvent.VK_5);
		...
		checkboxItemB.setMnemonic(KeyEvent.VK_6);
		...
		checkboxItemC.setMnemonic(KeyEvent.VK_7);
